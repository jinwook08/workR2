...
ob
obw <- sapply(ob,extractNoun,USE.NAMES = F)
bobw <- unlist(obw)
bobw2 <- bobw[nchar(obw)>=2]
bobw2
bobw2_table <- table(bobw2)
bobw2_table

wordcloud2(bobw2_table,
           color=rep_len(c('purple','hotpink','orange'  wb22            ,'steelblue'),
                         nrow(bobw2_table)))
